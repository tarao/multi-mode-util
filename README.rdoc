...
Locate <tt>multi-mode-util.el</tt>,
<tt>multi-mode-util-common.el</tt>, <tt>multi-mode+viper.el</tt> and
...
- Activating mark (especially with <tt>transient-mark-mode</tt>) accross the boundary between multiple modes does not work.
...
- Highlighting with <tt>jit-lock-mode</tt> was not working. (See issue #1)
