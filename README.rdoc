...
Locate <tt>multi-mode-util.el</tt> somewhere in your load path.

Write following line in your <tt>.emacs</tt>.
...
specific major mode for certain programming language between
<tt>&gt;|</tt><em>language</em><tt>|</tt> and
<tt>||&lt;</tt>. <tt>text-mode</tt> specified to
<tt>multi-mode-init</tt> is used for the rest of text in the buffer.
